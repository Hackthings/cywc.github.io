...
var rules = [
    ...
    [/(\S+? M) .-S-. (\S+? .) <-C-- \S+? . --C-> \S+? . --C-> (\S+? .)/g, '처조카'],
    [/(\S+? M) .-S-. (\S+? .) <-C-- \S+? . --C-> \S+? . --C-> \S+? . .-S-. (\S+? M)/g, '처조카사위'],
    [/(\S+? M) .-S-. (\S+? .) <-C-- \S+? . --C-> \S+? . --C-> \S+? . .-S-. (\S+? F)/g, '처조카며느리'],
    ...
    [/(\S+? M) .-S-. \S+? F <-C-- \S+? M <-C-- \S+? M --C-> \S+? M --C-> (\S+? M)/g, '처4촌(처종남매)'],
    [/(\S+? M) .-S-. \S+? F <-C-- \S+? M <-C-- \S+? M --C-> \S+? M --C-> (\S+? F)/g, '처4촌(처종자매)'],
    ...
    [/(\S+? M) .-S-. \S+? F <-C-- \S+? F <-C-- \S+? M --C-> \S+? M --C-> (\S+? M)/g, '처4촌(처외종남매)'],
    [/(\S+? M) .-S-. \S+? F <-C-- \S+? F <-C-- \S+? M --C-> \S+? M --C-> (\S+? F)/g, '처4촌(처외종자매)'],
    ...
    [/(\S+? M) .-S-. \S+? F <-C-- \S+? M <-C-- \S+? M --C-> \S+? F --C-> (\S+? M)/g, '처4촌(처내종남매)'],
    [/(\S+? M) .-S-. \S+? F <-C-- \S+? M <-C-- \S+? M --C-> \S+? F --C-> (\S+? F)/g, '처4촌(처내종자매)'],
    ...
    [/(\S+? M) .-S-. \S+? F <-C-- \S+? F <-C-- \S+? M --C-> \S+? F --C-> (\S+? M)/g, '처4촌(처이종남매)'],
    [/(\S+? M) .-S-. \S+? F <-C-- \S+? F <-C-- \S+? M --C-> \S+? F --C-> (\S+? F)/g, '처4촌(처이종자매)'],
    ...
    [/(\S+? M) .-S-. \S+? . <-C-- \S+? M <-C-- \S+? M <-C-- \S+? M --C-> \S+? M --C-> (\S+? M)/g, '처5촌(처당숙)'],
    [/(\S+? M) .-S-. \S+? . <-C-- \S+? M <-C-- \S+? M <-C-- \S+? M --C-> \S+? M --C-> (\S+? F)/g, '처5촌(처당고모)'],
    [/(\S+? M) .-S-. \S+? . <-C-- \S+? F <-C-- \S+? M <-C-- \S+? M --C-> \S+? M --C-> (\S+? M)/g, '처5촌(처외당숙)'],
    [/(\S+? M) .-S-. \S+? . <-C-- \S+? F <-C-- \S+? M <-C-- \S+? M --C-> \S+? M --C-> (\S+? F)/g, '처5촌(처당이모)'],
]
